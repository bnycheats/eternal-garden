...
export function Component() {
  ...
  usePrivateHeader({
    ...
    extra: (
      <div className="bg-m flex justify-center gap-2">
        <Button size="sm" variant="outline" onClick={() => navigate(paths.authenticated.ANNEX_MAP)}>
          Open Map
        </Button>
  ...
  return (
    <Fragment>
      <AddCryptFormSheet crypt_type={CryptType.ANNEX} open={openAddSheet} closeSheet={closeAddSheet} />
      {updateDetails && (
